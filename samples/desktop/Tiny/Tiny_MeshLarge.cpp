...
static GLFWwindow* initIGL(bool isHeadless) {
  ...
  GLFWwindow* window = isHeadless ? nullptr : glfwCreateWindow(width, height, title, nullptr, nullptr);
  ...
  {
    {
      ...
      auto ctx = vulkan::HWDevice::createContext(
          cfg, window ? (void*)glfwGetX11Window(window) : nullptr, 0, nullptr, (void*)glfwGetX11Display());
