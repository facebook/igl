...
if(NOT ALL_DISCOVERED_TARGETS)
    ...
    set(POTENTIAL_IGL_TARGETS
        # Core IGL targets
        IGLLibrary IGLOpenGL IGLMetal IGLVulkan IGLGlslang IGLstb
        
        # IGLU targets  
        IGLUimgui IGLUmanagedUniformBuffer IGLUsentinel IGLUshaderCross
        IGLUsimple_renderer IGLUstate_pool IGLUtexture_accessor IGLUtexture_loader
        IGLUuniform IGLUsimdtypes IGLUbitmap
        
        # Shell targets
        IGLShellShared
        
        # Third-party core libraries
        fmt glslang SPIRV spirv-cross-core spirv-cross-glsl spirv-cross-msl spirv-cross-util spirv-cross-c
        glslang-default-resource-limits
        
        # Graphics and media libraries
        ktx ktx_read ktx_version obj_basisu_cbind objUtil
        TracyClient bc7enc meshoptimizer tinyobjloader
        
        # ASTC encoder variants (for different SIMD instructions)
        astcenc-native-static astcenc-neon-static astcenc-avx2-static 
        astcenc-sse4.1-static astcenc-sse2-static astcenc-none-static
        
        # Additional third-party libraries that might be built
        glfw glew glew_s zlibstatic
    )
...
function(should_install_target target_name result_var)
    ...
    if("${target_name}" MATCHES "^(fmt|glslang|SPIRV|spirv-cross|ktx|glfw|glew|TracyClient|astcenc|meshoptimizer|tinyobjloader|bc7enc|stb)")
        set(${result_var} TRUE PARENT_SCOPE)
        return()
    endif()
...
if(NOT IGL_TARGETS_CONFIGURED)
    ...
    configure_package_config_file(
        ...
        "${CMAKE_CURRENT_BINARY_DIR}/cmake/IGLConfigHeadersOnly.cmake"
