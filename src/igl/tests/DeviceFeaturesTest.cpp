...
TEST(DeviceFeaturesEnumTest, EnumValues) {
  ...
  EXPECT_EQ(static_cast<int>(DeviceFeatures::DynamicVertexBufferStride), 14);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::ExplicitBinding), 15);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::ExplicitBindingExt), 16);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::ExternalMemoryObjects), 17);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::Indices8Bit), 18);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::MapBufferRange), 19);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::MeshShaders), 20);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::MinMaxBlend), 21);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::MultipleRenderTargets), 22);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::MultiSample), 23);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::MultiSampleResolve), 24);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::Multiview), 25);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::MultiViewMultisample), 26);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::PushConstants), 27);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::ReadWriteFramebuffer), 28);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::SamplerMinMaxLod), 29);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::ShaderLibrary), 30);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::ShaderTextureLod), 31);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::ShaderTextureLodExt), 32);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::SRGB), 33);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::SRGBSwapchain), 34);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::SRGBWriteControl), 35);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::StandardDerivative), 36);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::StandardDerivativeExt), 37);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::StorageBuffers), 38);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::Texture2DArray), 39);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::TextureArrayExt), 40);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::Texture3D), 41);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::TextureBindless), 42);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::TextureExternalImage), 43);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::TextureFilterAnisotropic), 44);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::TextureFloat), 45);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::TextureFormatRG), 46);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::TextureFormatRGB), 47);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::TextureHalfFloat), 48);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::TextureNotPot), 49);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::TexturePartialMipChain), 50);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::TextureViews), 51);
  EXPECT_EQ(static_cast<int>(DeviceFeatures::TimestampQueries), 52);
