...
TEST(TextureFormatUtilTest, textureFormatToVkFormat) {
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::Invalid), VK_FORMAT_UNDEFINED);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::A_UNorm8), VK_FORMAT_UNDEFINED);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::L_UNorm8), VK_FORMAT_UNDEFINED);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::R_UNorm8), VK_FORMAT_R8_UNORM);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::R_UNorm16), VK_FORMAT_R16_UNORM);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::R_F16), VK_FORMAT_R16_SFLOAT);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::R_UInt16), VK_FORMAT_R16_UINT);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::B5G5R5A1_UNorm),
            VK_FORMAT_B5G5R5A1_UNORM_PACK16);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::B5G6R5_UNorm),
            VK_FORMAT_B5G6R5_UNORM_PACK16);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::ABGR_UNorm4),
            VK_FORMAT_B4G4R4A4_UNORM_PACK16);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::LA_UNorm8), VK_FORMAT_UNDEFINED);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RG_UNorm8), VK_FORMAT_R8G8_UNORM);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RG_UNorm16), VK_FORMAT_R16G16_UNORM);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::R4G2B2_UNorm_Apple),
            VK_FORMAT_UNDEFINED);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::R4G2B2_UNorm_Rev_Apple),
            VK_FORMAT_UNDEFINED);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::R5G5B5A1_UNorm),
            VK_FORMAT_R5G5B5A1_UNORM_PACK16);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::BGRA_UNorm8),
            VK_FORMAT_B8G8R8A8_UNORM);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::BGRA_UNorm8_Rev),
            VK_FORMAT_UNDEFINED);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_UNorm8),
            VK_FORMAT_R8G8B8A8_UNORM);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBX_UNorm8),
            VK_FORMAT_R8G8B8A8_UNORM);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_SRGB), VK_FORMAT_R8G8B8A8_SRGB);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::BGRA_SRGB), VK_FORMAT_B8G8R8A8_SRGB);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RG_F16), VK_FORMAT_R16G16_SFLOAT);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RG_UInt16), VK_FORMAT_R16G16_UINT);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGB10_A2_UNorm_Rev),
            VK_FORMAT_A2R10G10B10_UNORM_PACK32);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGB10_A2_Uint_Rev),
            VK_FORMAT_A2R10G10B10_UINT_PACK32);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::BGR10_A2_Unorm),
            VK_FORMAT_A2B10G10R10_UNORM_PACK32);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::R_F32), VK_FORMAT_R32_SFLOAT);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RG_F32), VK_FORMAT_R32G32_SFLOAT);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGB_F16), VK_FORMAT_R16G16B16_SFLOAT);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_F16),
            VK_FORMAT_R16G16B16A16_SFLOAT);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGB_F32), VK_FORMAT_R32G32B32_SFLOAT);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_UInt32),
            VK_FORMAT_R32G32B32A32_UINT);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_F32),
            VK_FORMAT_R32G32B32A32_SFLOAT);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_ASTC_4x4),
            VK_FORMAT_ASTC_4x4_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::SRGB8_A8_ASTC_4x4),
            VK_FORMAT_ASTC_4x4_SRGB_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_ASTC_5x4),
            VK_FORMAT_ASTC_5x4_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::SRGB8_A8_ASTC_5x4),
            VK_FORMAT_ASTC_5x4_SRGB_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_ASTC_5x5),
            VK_FORMAT_ASTC_5x5_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::SRGB8_A8_ASTC_5x5),
            VK_FORMAT_ASTC_5x5_SRGB_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_ASTC_6x5),
            VK_FORMAT_ASTC_6x5_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::SRGB8_A8_ASTC_6x5),
            VK_FORMAT_ASTC_6x5_SRGB_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_ASTC_6x6),
            VK_FORMAT_ASTC_6x6_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::SRGB8_A8_ASTC_6x6),
            VK_FORMAT_ASTC_6x6_SRGB_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_ASTC_8x5),
            VK_FORMAT_ASTC_8x5_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::SRGB8_A8_ASTC_8x5),
            VK_FORMAT_ASTC_8x5_SRGB_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_ASTC_8x6),
            VK_FORMAT_ASTC_8x6_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::SRGB8_A8_ASTC_8x6),
            VK_FORMAT_ASTC_8x6_SRGB_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_ASTC_8x8),
            VK_FORMAT_ASTC_8x8_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::SRGB8_A8_ASTC_8x8),
            VK_FORMAT_ASTC_8x8_SRGB_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_ASTC_10x5),
            VK_FORMAT_ASTC_10x5_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::SRGB8_A8_ASTC_10x5),
            VK_FORMAT_ASTC_10x5_SRGB_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_ASTC_10x6),
            VK_FORMAT_ASTC_10x6_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::SRGB8_A8_ASTC_10x6),
            VK_FORMAT_ASTC_10x6_SRGB_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_ASTC_10x8),
            VK_FORMAT_ASTC_10x8_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::SRGB8_A8_ASTC_10x8),
            VK_FORMAT_ASTC_10x8_SRGB_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_ASTC_10x10),
            VK_FORMAT_ASTC_10x10_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::SRGB8_A8_ASTC_10x10),
            VK_FORMAT_ASTC_10x10_SRGB_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_ASTC_12x10),
            VK_FORMAT_ASTC_12x10_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::SRGB8_A8_ASTC_12x10),
            VK_FORMAT_ASTC_12x10_SRGB_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_ASTC_12x12),
            VK_FORMAT_ASTC_12x12_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::SRGB8_A8_ASTC_12x12),
            VK_FORMAT_ASTC_12x12_SRGB_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_PVRTC_2BPPV1),
            VK_FORMAT_PVRTC1_2BPP_UNORM_BLOCK_IMG);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGB_PVRTC_2BPPV1),
            VK_FORMAT_PVRTC1_2BPP_UNORM_BLOCK_IMG);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_PVRTC_4BPPV1),
            VK_FORMAT_PVRTC1_4BPP_UNORM_BLOCK_IMG);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGB_PVRTC_4BPPV1),
            VK_FORMAT_PVRTC1_4BPP_UNORM_BLOCK_IMG);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGB8_ETC1), VK_FORMAT_UNDEFINED);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGB8_ETC2),
            VK_FORMAT_ETC2_R8G8B8_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::SRGB8_ETC2),
            VK_FORMAT_ETC2_R8G8B8_SRGB_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGB8_Punchthrough_A1_ETC2),
            VK_FORMAT_ETC2_R8G8B8A1_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::SRGB8_Punchthrough_A1_ETC2),
            VK_FORMAT_ETC2_R8G8B8A1_SRGB_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA8_EAC_ETC2), VK_FORMAT_UNDEFINED);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::SRGB8_A8_EAC_ETC2),
            VK_FORMAT_UNDEFINED);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RG_EAC_UNorm),
            VK_FORMAT_EAC_R11G11_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RG_EAC_SNorm),
            VK_FORMAT_EAC_R11G11_SNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::R_EAC_UNorm),
            VK_FORMAT_EAC_R11_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::R_EAC_SNorm),
            VK_FORMAT_EAC_R11_SNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::Invalid), VK_FORMAT_UNDEFINED);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_BC7_UNORM_4x4),
            VK_FORMAT_BC7_UNORM_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::RGBA_BC7_SRGB_4x4),
            VK_FORMAT_BC7_SRGB_BLOCK);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::Z_UNorm16), VK_FORMAT_D16_UNORM);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::Z_UNorm24),
            VK_FORMAT_D24_UNORM_S8_UINT);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::Z_UNorm32), VK_FORMAT_D32_SFLOAT);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::S8_UInt_Z24_UNorm),
            VK_FORMAT_D24_UNORM_S8_UINT);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::S8_UInt_Z32_UNorm),
            VK_FORMAT_D32_SFLOAT_S8_UINT);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::S_UInt8), VK_FORMAT_S8_UINT);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::YUV_NV12),
            VK_FORMAT_G8_B8R8_2PLANE_420_UNORM);
  ASSERT_EQ(util::textureFormatToVkFormat(igl::TextureFormat::YUV_420p),
